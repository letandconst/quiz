...
export default function Home() {
  ...
  const quizData = [
    {
      question:
        'Az első kódot a *Ximen Walking District*-ben (+ chinese letters) találjátok a Walker feliratú kör 100 méteres körzetében.  Figyeljetek a járókelőkre, és ne lábatlankodjatok sokáig, hiszen sietnetek kell!',
      correctAnswer: '1268',
      type: 'text',
    },
    {
    ...
    {
      question:
        'Mi a neve a Fülöp-szigetek északi hegyvidékein élő törzseknek?',
    ...
    {
      question:
        'Ahhoz, hogy kiderítsétek az utolsó kódot, menjetek a *Xinyi* *District*-be, ( plus chinese letters) és hegyezzétek a fületeket! ',
      correctAnswer: '1976',
      type: 'text',
    },
    {
      question:
        'Mi a neve a kínai gőzgombócnak, amit változatos töltelékekkel árulnak?',
  ...
  return (
    ...
    >
      ...
      <QuizCard data={quizData} handleShowCountdown={handleShowCountdown} />
    </Box>
  );
}
